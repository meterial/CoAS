...
def set_hparams(config='', exp_name='', hparams_str='', print_hparams=False, global_hparams=True):
    if config == '' and exp_name == '':
        ...
        parser.add_argument('--config', type=str, default='modules/ProDiff/config/prodiff.yaml',
                            help='location of the data corpus')
        parser.add_argument('--exp_name', type=str, default='ProDiff', help='exp_name')
        parser.add_argument('--hparams', type=str, default="", help='location of the data corpus')
        parser.add_argument('--infer', action='store_true', help='infer')
        parser.add_argument('--validate', action='store_true', help='validate')
        parser.add_argument('--reset', action='store_true',default=True,help='reset hparams')
